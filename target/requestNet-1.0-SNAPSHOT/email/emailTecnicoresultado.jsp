    ...
    <body>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="emailTecnico.xhtml"><i class="active lnr lnr-envelope"></i> <span>Enviar correo</span></a></li>
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="../tecnicoSenior/dashboard.jsp" class=""><i class="lnr lnr-home"></i> <span>Escritorio</span></a></li>
                        <li><a href="../tecnicoSenior/inventario.xhtml" class=""><i class="lnr lnr-file-empty"></i> <span>Inventario</span></a></li>
                        <li><a href="../tecnicoSenior/novedades.xhtml" class=""><i class="lnr lnr lnr-layers"></i> <span>Novedades</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
