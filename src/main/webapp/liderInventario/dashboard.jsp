            ...
            <div class="container-fluid">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../resources/img/userMen2.jpg" class="img-circle" alt="Avatar"></img><span>Miguel Baron</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="lnr lnr-user"></i> <span>Lider Inventario</span></a></li>
                                <li><a href="../email/emailLider.xhtml"><i class="lnr lnr-envelope"></i> <span>Enviar mensaje</span></a></li>
