    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../resources/img/userMen2.jpg" class="img-circle" alt="Avatar"></img><span>Leidy Alfonso</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="lnr lnr-user"></i> <span>Lider Inventario</span></a></li>
                                <li><a href="emailLider.xhtml"><i class="active lnr lnr-envelope"></i> <span>Enviar correo</span></a></li>
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="../liderInventario/dashboard.jsp" class=""><i class="lnr lnr-home"></i> <span>Escritorio</span></a></li>
                        <li><a href="../liderInventario/inventario.xhtml" class=""><i class="lnr lnr-file-empty"></i> <span>Inventario</span></a></li>
                        <li><a href="../liderInventario/novedades.xhtml" class=""><i class="lnr lnr lnr-layers"></i> <span>Novedades</span></a></li>
                        <li><a href="../liderInventario/proveedores.xhtml" class=""><i class="lnr lnr-cog"></i> <span>Proveedores</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
                                    ...
                                    <%
                                        ...
                                        if (resultado) {
                                            out.print(
                                                ...
                                                + "<br>"
                                                + "<a class='buttonLineRed' href='emailLider.xhtml'>Enviar un mensaje nuevo.</a>"
                                            );
                                        } else {
                                            out.print(
                                                ...
                                                + "<br>"
                                                + "<a class='buttonLineRed' href='emailLider.xhtml'>Intentar de nuevo.</a>"
                                            );
                                        }
                                    %>                            
                                </div>
